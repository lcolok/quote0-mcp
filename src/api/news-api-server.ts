    ...
    endpoints: {
      'POST /news/process': {
        ...
        parameters: {
          ...
          processor: 'string (passthrough|basic-llm|prompt-profile|ax-optimized) - 处理器；ax-optimized 仅兼容旧任务',
          index: 'number - 新闻条目索引',
      ...
      'POST /news/scheduler/jobs': {
        ...
        parameters: {
          ...
          processor: 'string - 处理器 (passthrough, basic-llm, prompt-profile；ax-optimized 仅兼容旧任务)',
